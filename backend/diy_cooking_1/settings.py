"""
Django settings for diy_cooking_1 project.
...
ROOT_URLCONF = "diy_cooking_1.urls"
...
WSGI_APPLICATION = "diy_cooking_1.wsgi.application"
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "DIY Cooking Support <support@diy-cooking-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "diy_cooking_1 API",
    "DESCRIPTION": "API documentation for diy_cooking_1 App",
    "VERSION": "v1",
}
